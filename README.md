...
HTTP Communication: Used Angular's HttpClient to interact with backend services and manage API requests.

Database Management:
Relational Database Design: Designed and managed a relational database schema to store task-related data.
CRUD Operations: Implemented Create, Read, Update, and Delete operations for managing tasks.

Project Management Features:
Task Management: Enabled users to create, update, and delete tasks, and organize them effectively.
User Management: Included functionalities for user registration and profile management.
